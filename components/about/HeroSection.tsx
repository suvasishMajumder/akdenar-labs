...
export default function HeroSection() {
    return (
        <section className="bg-bg-primary w-full py-20 md:py-24 px-4 sm:px-6 md:px-10 lg:px-20 text-center flex flex-col items-center">
            ...
            {/* Responsive Image */}
            <div className="mt-10 w-full max-w-[95%] sm:max-w-[90%] md:max-w-[80%] lg:max-w-[1200px]">
                <Image
